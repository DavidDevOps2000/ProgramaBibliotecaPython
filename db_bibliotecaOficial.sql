...
-- -----------------------------------------------------
 CREATE USER 'ProjetoFinal'@'localhost' IDENTIFIED BY '123456';
 GRANT SELECT, DELETE, INSERT, UPDATE, EXECUTE ON db_biblioteca.* TO 'ProjetoFinal'@'localhost';
...
-- fk_id_bibliotecario int not null,
-- senha varchar(12),
-- FOREIGN KEY (fk_id_bibliotecario) REFERENCES tbl_LOGIN (codigo_bibliotecario)); #REFENCIADO NA TBL_BIBLIOTECARIO 
-- -----------------------------------------------------
-- Tabela tbl_Editora
-- -----------------------------------------------------
...
CREATE TABLE tbl_Emprestimo (
	...
	FOREIGN KEY (FK_Cliente) REFERENCES tbl_Cliente (cod_cliente)
);
...
CREATE TABLE Livro_Emprestimo (
    ...
    situacaoLivro enum('Emprestado','Desativado') default 'Emprestado' not null,
	PRIMARY KEY (FK_Livro, FK_Emprestimo),
	FOREIGN KEY (FK_Livro) REFERENCES tbl_Livros (codigo_livro),
	FOREIGN KEY (FK_Emprestimo) REFERENCES tbl_Emprestimo (cod_emprestimo)
);
...
-- -----------------------------------------------------
INSERT INTO tbl_Cliente (nome, cpf, nasc, email, telefone) VALUES 
	('João da Silva','78381786155','1980/01/01', 'joao@dasilva.com','(11)98759-7865'),
	('Frederico José','67775470231','1981/12/24','fred@jose.com','(11)98759-7865'),
	('Alberto Santos','84214853574','1991/03/20','alberto@santos.com','(11)98759-7865'),
	('Renata Alonso','72123271809','1986/07/18','renata@alonso.com','(11)98759-7865'),
	('Paulo da Silva','65601538368','1988/09/10','paulo@dasilva.com','(11)98759-7865'),
	('Hermelino Costa','46212433041','1993/10/09','hermelino@costa.com','(11)98759-7865'),
	('Claudensio Pereira','18217425115','2004/12/30','claudensio@pereira.com','(11)98759-7865'),
	('Maximiliano Alegre','29310165717','1985/12/25','maximiliano@alegre.com','(11)98759-7865'),
	('Fabiola Nunes','69357114688','1997/09/04','fabiola@nunes.com','(11)98759-7865'),
	('Pedro Souza','69357114682','2002/04/11','pedro@souza.com','(11)98759-7865'),
	('Ellen Bernard','63315637127','2000/05/22','ellen@bernard.com','(11)98759-7865'),
	('Ulisses Costa','55336792842','1996/10/06','ulisses@costa.com','(11)98759-7865'),
	('Felipe Silva','55861699990','1980/11/11','felipe@silva.com','(11)98759-7865'),
	('Veronica Santos','18642784903','1981/10/26','vernica@santos.com','(11)98759-7865'),
	('Mikaely Costa','37768351764','1993/10/17','mikaely@costa.com','(11)98759-7865'),
	('Almir Leon','37768351767','2004/12/30','almir@leon.com','(11)98759-7865'),
	('Franklin Senna','38579791918','1987/10/12','franklin@senna.com','(11)98759-7865'),
	('Carlos Nunes','21404485001','1991/03/20','carlos@nunes.com','(11)98759-7865'),
	('Carlos Adao','58212236118','1991/03/20','carlos@adao.com','(11)98759-7865');

-- -----------------------------------------------------
-- Insert's tbl_bibliotecaria
-- -----------------------------------------------------
INSERT INTO tbl_bibliotecario (nome_bibliotecario, nasc_bibliotecario, telefone, FK_Biblio_responsavel,senha) VALUES 
	('Marcos','1980/07/12', '11 4517-1554',null,'12345'),
    ('Cristiano','1980/07/12', '11 5485-4155',1,'44744'),
    ('Luís','1993/10/17', '11 4002-8922',1,'58469'),
    ('Aline','1980/07/12', '11 5481-5563',1,'23243'),
    ('Diego','1980/07/12', '11 98154-8451',1,'82912'),
    ('Francisco','1980/07/12', '11 98765-4321',2,'14512'),
    ('Pamela','1995/11/04', '11 96841-5525',3,'45151'),
    ('Rodrigo','1993/05/07', '11 4584-8950',null,'45458'),
    ('Fabiana','1988/12/15', '11 95281-5443',3,'54654'),
    ('Allan','1980/02/01', '11 98564-8041',1,'54848'),
    ('Cristiane','1990/09/18', '11 95255-0481',3,'548ss');
...
-- -----------------------------------------------------
INSERT INTO Livro_Emprestimo(fk_livro, fk_emprestimo) VALUES
	(7, 1 ),
	(26, 1 ),
	(37, 1 ),
	(34, 2 ),
